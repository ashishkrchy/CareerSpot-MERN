          ...
          <>
            ...
            <div className="space-y-6">
              {jobsWishlist.map((job) => (
                <div
                  key={job._id}
                  className="bg-gray-900/50 rounded-xl p-6 border-2 border-gray-800 hover:border-blue-600 transition-colors"
                >
                  <div className="flex flex-col md:flex-row justify-between gap-6">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-blue-400">{job.company?.name}</p>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col gap-3">
                      <Button
                        ...
                        className="bg-gradient-to-r from-blue-600 to-red-600 hover:from-blue-700 hover:to-red-700 text-white font-bold cursor-pointer"
                      >
